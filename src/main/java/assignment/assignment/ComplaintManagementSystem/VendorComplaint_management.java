 ...
 * @author TeD
 */
public class VendorComplaint_management extends javax.swing.JFrame {

    /**
     * Creates new form Complaint_management
     */
    public VendorComplaint_management() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VendorComplaint_management.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VendorComplaint_management().setVisible(true);
            }
        });
    }
