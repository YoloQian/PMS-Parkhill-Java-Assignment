...
public class FacilityManagementMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        facilitynewBTN.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                facilitynewBTNActionPerformed(evt);
            }
        });

        facilityupdateBTN.setText("Update");
        facilityupdateBTN.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                facilityupdateBTNActionPerformed(evt);
            }
        });
    ...
    private void facilitynewBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_facilitynewBTNActionPerformed
        // TODO add your handling code here:
        FacilityNew FacilityNew = new FacilityNew();
        this.dispose();
        FacilityNew.setVisible(true);
    }//GEN-LAST:event_facilitynewBTNActionPerformed

    private void facilityupdateBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_facilityupdateBTNActionPerformed
        // TODO add your handling code here:
        FacilityModify FacilityModify = new FacilityModify();
        this.dispose();
        FacilityModify.setVisible(true);
    }//GEN-LAST:event_facilityupdateBTNActionPerformed
