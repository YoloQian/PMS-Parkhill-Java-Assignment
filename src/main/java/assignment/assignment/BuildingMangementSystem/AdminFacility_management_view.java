 ...
 * @author leeyu
 */
public class AdminFacility_management_view extends javax.swing.JFrame {

    /**
     * Creates new form VisitorPassView
     */
    public AdminFacility_management_view() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        AdminImportFacilityData = new javax.swing.JButton();
        ...
        AdminFacilityDelete.setText("Delete");
        ...
        AdminImportFacilityData.setText("Import Data");
        AdminImportFacilityData.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                AdminImportFacilityDataActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(118, 118, 118)
                .addComponent(AdminImportFacilityData)
                .addGap(18, 18, 18)
    ...
    private void AdminImportFacilityDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdminImportFacilityDataActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_AdminImportFacilityDataActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminFacility_management_view.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminFacility_management_view().setVisible(true);
            }
        });
    }
